...
CREATE TABLE "WeeklyTimesheet" (
    ...
    "totalMinutesGross" INTEGER NOT NULL DEFAULT 0,
    "totalBreakMinutes" INTEGER NOT NULL DEFAULT 0,
    "totalMinutesNet" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "ProjectAssignment_projectId_workerId_idx" ON "ProjectAssignment"("projectId", "workerId");
...
-- CreateIndex
CREATE INDEX "TimeEntry_workerId_projectId_occurredAtServer_idx" ON "TimeEntry"("workerId", "projectId", "occurredAtServer");
...
-- AddForeignKey
ALTER TABLE "CustomerCallLog" ADD CONSTRAINT "CustomerCallLog_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
